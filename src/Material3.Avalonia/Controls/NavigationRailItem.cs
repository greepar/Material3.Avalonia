...
/// <summary>
/// Destination for a <see cref="NavigationRail"/>: a 24dp <see cref="Icon"/> inside a
/// 56x32 pill-shaped active indicator plus a label-medium <see cref="Label"/> beneath.
...
public class NavigationRailItem : ListBoxItem
{
    public static readonly StyledProperty<object?> IconProperty =
        AvaloniaProperty.Register<NavigationRailItem, object?>(nameof(Icon));
